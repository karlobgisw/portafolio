export function PortfolioItem({title, imgUrl, gitUrl, demoUrl}){
    ...
    <article className="portfolio-item bg-[#130f2a] p-5 rounded-[2rem] border-2 border-solid border-[#6852ba] transition-all duration-500 ease-in-out">
        ...
        <div className="portfolio-cta flex gap-4 mb-4">
            <a href={gitUrl} className=" p-3 border border-[#6751b9] rounded-xl bg-transparent text-[#6751b9] font-bold mr-1 flex justify-center items-center transition-all duration-500 ease-in-out cursor-pointer hover:bg-white" target="_blank">
            ...
            <a href={demoUrl} className="  p-3 border border-[#6751b9] rounded-xl bg-transparent text-[#6751b9] font-bold mr-1 flex justify-center items-center transition-all duration-500 ease-in-out cursor-pointer hover:bg-white" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" className="mr-2 fill-[#6751b9]" width="16" height="16" viewBox="0 0 16 16">
