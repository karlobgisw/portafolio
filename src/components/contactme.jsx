        ...
        <div className="w-full h-auto bg-gradient-to-t from-[#111132] to-[#0c0c1d]">
            ...
            <div className="contact-container mx-12 relative">
                ...
                <div className="contact-content flex gap-12 max-md:flex-col-reverse">
                    <div style={{flex: 1}}>
                        <ContactCard iconUrl="../src/assets/images/email.svg" text="karlobgisw@gmail.com"></ContactCard>
                        <ContactCard iconUrl="../src/assets/images/telephone.svg" text="(+52) 618-290-9507"></ContactCard>
                    </div>
                    <div style={{flex: 1}}>
